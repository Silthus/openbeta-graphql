...
export type GetXMediaInput = {
  xMediaIds: Array<InputMaybe<Scalars['ID']['input']>>;
};

export type GetXMediaResponse = {
...
export type MutationAddXMediaArgs = {
...
export type MutationRemoveXMediaArgs = {
...
export type QueryGetXMediaArgs = {
...
export type RemoveXMediaInput = {
  xMediaId: Scalars['ID']['input'];
};

export type RemoveXMediaResponse = {
